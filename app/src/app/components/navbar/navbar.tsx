  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-[#2144e1] px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Baixe agora nosso app na Play Store e Apple Store
          <IoLogoGooglePlaystore className="ml-2 h-6 w-6" />
          <IoLogoAppleAppstore className="ml-2 h-6 w-6" />
        </p>
        <nav
          aria-label="Top"
        ...
        >
          <div className="flex h-16 items-center">
            ...
            {/* Logo */}
            <div className="ml-4 flex lg:ml-0 justify-start items-start h-full py-3">
              <a href="/">
                <Image
                  width={130}
                  height={130}
            ...
            <div className="ml-auto flex items-center">
              ...
              <div className="flow-root">
                ...
                <PopupCart />
                  <span className="ml-2 text-[12px] font-medium text-white bg-blue-600 w-5 h-5 rounded-md flex justify-center items-center absolute top-6 -right-1">
                    0
                  </span>
